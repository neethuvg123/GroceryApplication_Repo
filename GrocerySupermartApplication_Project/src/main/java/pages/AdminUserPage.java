...
public WebDriver driver;
	...
	@FindBy(xpath="//a[@href='javascript:void(0)']//child::i") WebElement newButton;
	
	@FindBy(xpath="//input[@id='username']")WebElement usernametextbox;
	
	@FindBy(xpath="//input[@id='password']")WebElement passwordtextbox;
	
	@FindBy(xpath="//select[@class='form-control' and @name='user_type']") WebElement selectoption;
